...
export const bom = [
  ...
  { title: '物料', dataIndex: 'targetMaterialId', hideTable: true, required: true },
  { title: '物料代码', dataIndex: 'targetMaterialCode', hideTable: true, hideForm: true },
  { title: '物料名称', dataIndex: 'targetMaterialName', hideForm: true },
  { title: '物料数量', dataIndex: 'targetMaterialNum' },
